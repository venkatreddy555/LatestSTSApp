...
class AdminApprovedRequestListDataModel {
  AdminApprovedRequestListDataModel({
  ...
  AdminApprovedRequestListDataModel.fromJson(dynamic json) {
...
AdminApprovedRequestListDataModel copyWith({  String? parentRequestId,
  String? dateOfRequest,
  String? personName,
  String? mobileNo,
  String? idProofImagePath,
  ...
  String? fatherName,
  String? fatherMobileNo,
}) => AdminApprovedRequestListDataModel(  parentRequestId: parentRequestId ?? _parentRequestId,
